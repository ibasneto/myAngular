...
describe('injector', function () {
  ...
  it('down now allow a constant called hasOwnProperty', function () {
    var module = angular.module('myModule', []);
  ...
  it('invokes an annotated function with dependecy injection', function () {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
...
describe('annotate', function () {
 beforeEach(function () {
  ...
  it('invokes a non-annotated function with dependecy injection', function () {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
  ...
  it('configures all modules before running any run blocks', function () {
    ...
    var result;
    module1.run(function (a, b) { result = a + b; });
    var module2 = angular.module('myOtherModule', []);
  ...
  it('allows changing an instance using a decorator', function () {
    ...
    var injector = createInjector(['myModule']);
    var value = injector.get('aValue');
    expect(value.aKey).toBe(42);
    expect(value.decoratedKey).toBe(43);
  });
  ...
  it('allows multiple decorators per service', function () {
    ...
    var injector = createInjector(['myModule']);
    var value = injector.get('aValue');
    expect(value.decoratedKey).toBe(42);
    expect(value.otherDecoratedKey).toBe(43);
  });
