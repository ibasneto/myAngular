...
describe('Scope', function () {
  ...
  describe('digest', function () {
    ...
    it('calls listener with the new value as old value the first time', function () {
      var oldValueGiven;
      scope.someValue = 123;
      scope.$watch(
        function (scope) { return scope.someValue; },
    ...
    it('compares based on value if enbled', function () {
      scope.aValue = [1, 2, 3];
      scope.counter = 0;
      scope.$watch(
        function (scope) { return scope.aValue; },
  ...
  describe('inheritance', function () {
    ...
    it('does ot shadow members of parent scope\'s attributes', function () {
      var parent = new Scope();
      var child = parent.$new();
    ...
    it('keeps a record of its chilren', function () {
      var parent = new Scope();
